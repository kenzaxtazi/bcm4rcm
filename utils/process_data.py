...
model_dict = {'CanESM2':['CanESM2', 'RegCM4'], 'NOAA_IITM':['NOAA', 'RegCM4'], 'CNRM_RegCM4': ['CNRM', 'RegCM4'], 
              ...
              'EC-EARTH':['ECEARTH', 'RCA4'], 'MIROC': ['MIROC','RCA4'], 'NOAA_SMHI':['NOAA', 'RCA4'],
              'CNRM_RCA4': ['CNRM', 'RCA4'], 'MPI_RCA4': ['MPI', 'RCA4'], 'IPSL_RCA4': ['IPSL', 'RCA4'],
...
def process_data(model_list: list, experiment: str, minyear: str, maxyear: str):
    ...
    for model in model_list:
        model_ds = cordex.collect_CORDEX(domain, minyear=minyear, maxyear=maxyear, experiment=experiment, 
        ...
        df.to_csv('/Users/kenzatazi/Documents/CDT/Code/bcm4rcm/data/processed/'+ experiment + '_' 
                   + model_dict[model][0] + '_' + model_dict[model][1] + '_'
                   + minyear + '_' + maxyear + '.csv')